...
## 
defmodule Commodity.Api.Iam.User.PhoneNumber.LogTest do
	use Commodity.DataCase

	alias Commodity.Api.Iam.User.PhoneNumber.Log

	test "changeset with valid params" do
		changeset = Log.changeset(%Log{}, %{user_id: 1, number_id: 1, 
			source_user_id: 1})
	...
	test "changeset with invalid params" do
		changeset = Log.changeset(%Log{}, %{user_id: "id", number_id: "id",
			source_user_id: "id"})
	...
	test "changest without user_id param" do
		changeset = Log.changeset(%Log{}, %{number_id: 1, source_user_id: 1})
