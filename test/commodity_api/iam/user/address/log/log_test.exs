...
## 
defmodule Commodity.Api.Iam.User.Address.LogTest do
	use Commodity.DataCase

	alias Commodity.Api.Iam.User.Address.Log

	test "changeset with valid params" do
		changeset = Log.changeset(%Log{}, %{user_id: 1, address_id: 1, 
			source_user_id: 1})
	...
	test "changeset with invalid params" do
		changeset = Log.changeset(%Log{}, %{user_id: "id", address_id: "id",
			source_user_id: "id"})
	...
	test "changest without user_id param" do
		changeset = Log.changeset(%Log{}, %{address_id: 1, source_user_id: 1})
