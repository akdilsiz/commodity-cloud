...
## 
defmodule Commodity.Api.Iam.User.Email.Log do
	use Commodity.Api, :model

	@derive {Jason.Encoder, only: [:id, :user_id, :email_id, :source_user_id,
		:inserted_at]}
	...
	def changeset(struct, params \\ %{}) do
		struct
		|> cast(params, [:user_id, :email_id, :source_user_id])
		|> validate_required([:user_id, :email_id, :source_user_id])
