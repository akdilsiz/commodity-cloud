...
## 
defmodule Commodity.Api.Iam.User.Address.Log do
	use Commodity.Api, :model

	@derive {Jason.Encoder, only: [:id, :user_id, :address_id, :source_user_id,
		:inserted_at]}

	schema "user_address_logs" do
	...
	def changeset(struct, params \\ %{}) do
		struct
		|> cast(params, [:user_id, :address_id, :source_user_id])
		|> validate_required([:user_id, :address_id, :source_user_id])
